...
const ProfilePage = () => {
  // Option B: keep query locally (for future lists/sections to consume)
      ...
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 border relative">
          ...
          <div className="text-sm text-gray-700 pr-24">
            Add more security to your account by enabling Two Factor Authentication. When logging in,
            you will need to enter a code generated by your preferred authenticator app.
          </div>
